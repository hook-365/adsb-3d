...
**Compatible with any ADS-B receiver running tar1090, readsb, dump1090, or ultrafeeder** - point it at your local receiver or any feed that exposes the `/data/aircraft.json` endpoint.
