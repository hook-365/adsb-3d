...
export const settingsStrings = {
  ...
  'settings.trail_length_desc': 'Minutos aproximados de historial por estela. «Completa» dibuja todo lo registrado; la aeronave seleccionada siempre muestra su estela completa.',
