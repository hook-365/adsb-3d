...
export const settingsStrings = {
  ...
  'settings.trail_length_desc': 'Approximate minutes of history drawn per trail. Full renders everything collected; the selected aircraft always shows its full trail.',
